...
-- Trigger function to automatically create an active Chequing Account for all new signups
...
-- Backfill: Provision an active default Chequing account for all existing users who don't have one
insert into public.user_bank_accounts (
  user_id,
  account_category,
  account_type,
