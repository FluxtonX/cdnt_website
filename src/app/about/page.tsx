        ...
        <section className="px-6 py-24 bg-white">
          <div className="mx-auto max-w-7xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-[#0A0F2C] mb-4">Why Choose North Union Bank</h2>
        ...
        <section className="bg-[#1A3FBB] py-24 px-6">
          <div className="mx-auto max-w-7xl text-center">
            ...
            <p className="text-lg text-white/90 mb-10 font-medium">
              Join thousands of Canadians who trust North Union Bank for their crypto banking needs
            </p>
            <Link 
              href="/register" 
