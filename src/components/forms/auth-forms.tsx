...
export function LoginForm() {
  ...
  async function onSubmit(values: LoginValues) {
    ...
    notify({
      ...
      description: "Establishing an encrypted session with the North Union server.",
    });
...
export function RegisterForm() {
  ...
  async function onSubmit(values: RegisterValues) {
    ...
    notify({
      ...
      description: "Welcome to North Union. Let's verify your identity.",
    });
